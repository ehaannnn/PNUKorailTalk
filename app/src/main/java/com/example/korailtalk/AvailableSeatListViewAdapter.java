...
/**
 * Created by 한결 on 2017-06-25.
 */
public class AvailableSeatListViewAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.available_train_items, parent, false);
        }
